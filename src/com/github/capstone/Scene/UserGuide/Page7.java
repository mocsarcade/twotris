...
public class Page7 extends GuidePage
{
    public Page7(MainMenu menu)
    {
        ...
        this.pageContent = "There are seven different shaped pieces, so the more you have<br>" +
                "on the board, the more challenging the game gets!<br>" +
                "Make sure to keep an eye on the upcoming piece, to help you<br>" +
                "    plan your next move.";
    }
}